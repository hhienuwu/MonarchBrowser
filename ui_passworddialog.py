...
try:
    ...
    class Ui_PasswordDialog(object):
        ...
        def retranslateUi(self, PasswordDialog):
            PasswordDialog.setWindowTitle(QCoreApplication.translate("Hộp Thoại Password", u"Yêu cầu xác thực", None))
            self.m_iconLabel.setText(QCoreApplication.translate("Hộp Thoại Password", u"Icon", None))
            self.m_infoLabel.setText(QCoreApplication.translate("Hộp Thoại Password", u"Thông tin", None))
            self.userLabel.setText(QCoreApplication.translate("Hộp Thoại Password", u"Tên đăng nhập:", None))
            self.passwordLabel.setText(QCoreApplication.translate("Hộp Thoại Password", u"Password:", None))
except:
    ctypes.windll.user32.MessageBoxW( 0,"Không thể khởi chạy hộp thoại password, xin vui lòng cài lại trình duyệt", "Monarch Browser", 1)
