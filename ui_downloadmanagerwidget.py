...
"}")
    ...
    def retranslateUi(self, DownloadManagerWidget):
        DownloadManagerWidget.setWindowTitle(QCoreApplication.translate("DownloadManagerWidget", u"File downloads", None))
        self.m_zeroItemsLabel.setText(QCoreApplication.translate("DownloadManagerWidget", u"File downloads của bạn sẽ xuất hiện tại đây.", None))
